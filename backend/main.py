...
@admin_cli.command(name="run", help="启动 Admin 服务, 运行 python main.py run --env=dev 不加参数默认 dev 环境")
...
@admin_cli.command(name="revision", help="生成新的 Alembic 迁移脚本, 运行 python main.py revision --env=dev")
...
@admin_cli.command(name="upgrade", help="应用最新的 Alembic 迁移, 运行 python main.py upgrade --env=dev")
