...
class UserModel(ModelMixin, UserMixin):
    ...
    __table_args__ = (UniqueConstraint("username"), {"comment": "用户表"})
    ...
    mobile: Mapped[str | None] = mapped_column(String(11), nullable=True, unique=True, index=True, comment="手机号")
    email: Mapped[str | None] = mapped_column(String(64), nullable=True, unique=True, index=True, comment="邮箱")
